...
![ECG Waveform Example](./images/ecg_image.png)
*Hình 1: Minh họa tín hiệu ECG thu thập từ Board B trước khi qua bộ lọc thích nghi.*
...
![AI Diagnostics Demo](./images/ai_diagnostics.png)
*Hình 3: Kết quả phân loại nhịp tim thời gian thực sử dụng mô hình TensorFlow Lite.*
...
![PPG Waveform Example](./images/PPG.jpg)
*Hình 2: Tín hiệu PPG thu thập từ cảm biến MAX30102 phục vụ tính toán nồng độ Oxy.*
