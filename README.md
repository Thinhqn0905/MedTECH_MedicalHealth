...
Giao diện ứng dụng di động được thiết kế hiện đại, trực quan, tối ưu cho trải nghiệm người dùng trên cả Android và iOS:

| **Main Dashboard** | **AI Diagnostics** |
|:---:|:---:|
| ![Dashboard](./docs/images/real_dashboard.png) | ![AI Diagnostics](./docs/images/real_ai_diagnostics.png) |

> **Tính năng giao diện:**
> - **Dashboard**: Theo dõi tức thời các chỉ số sinh tồn cơ bản như nhịp tim (BPM) và nồng độ oxy (SpO2).
> - **AI Diagnostics**: Phân tích chuyên sâu về biến thiên nhịp tim (HRV) và đưa ra chẩn đoán về tình trạng sức khỏe tim mạch.
> - **One-tap Export**: Xuất báo cáo y tế chuyên nghiệp chỉ với một lần nhấn.
